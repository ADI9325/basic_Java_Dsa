        ...
        public static void checkSpellingAndSpace(String sentence) {
            ...
            for (String word : words) {
                ...
                if (dictionary.contains(word)) {
                    ...
                    // If the word is not in the dictionary, look for a similar word with one
            ...
            // Remove the trailing space and print the corrected sentence
            System.out.println(correctedSentence.toString().trim());
        }

        public static void main(String[] args) {
            // Example usage:
            String sentence = "environmet alwys protec irreplaceabl";
